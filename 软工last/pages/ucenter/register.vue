		...
		<view class="registercontent">
			<view class="has-mglr-10 ">
				<view class=" has-mgtb-10 ">
					<input v-model="username" type="text" maxlength="11" placeholder="请输入用户名" class="is-input1 " />
				</view>


				<view class=" has-radius has-mgtb-10">
					<input v-model="password" placeholder="请输入登录密码" :password="true" class="is-input1" />

				</view>
				<view class=" registerbtn has-radius has-mgtb-20" @click="regist()">
					<button>注 册</button>
				</view>
			</view>
		</view>
